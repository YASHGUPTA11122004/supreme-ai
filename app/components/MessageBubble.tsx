...
export default function MessageBubble({ message }: { message: Message }) {
  ...
  return (
    <div className={`flex items-end gap-2 ${isUser ? "justify-end" : "justify-start"}`}>
      ...
      {/* AI Avatar */}
      {!isUser && (
        <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-violet-600 to-purple-900 flex items-center justify-center shrink-0 shadow-lg shadow-violet-900/30">
